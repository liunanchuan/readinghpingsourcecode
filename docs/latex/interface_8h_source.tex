...
\DoxyCodeLine{18     \mbox{\hyperlink{ars_8h_a5ece5635db977edd094b1c365c0357a3}{\_\_u16}}  \mbox{\hyperlink{structmii__data_a0ca027ac6500939fcdcef00f9dc7332b}{phy\_id}};}
\DoxyCodeLine{19     \mbox{\hyperlink{ars_8h_a5ece5635db977edd094b1c365c0357a3}{\_\_u16}}  \mbox{\hyperlink{structmii__data_a4955c4448558cb454080e1d64f16c9b4}{reg\_num}};}
\DoxyCodeLine{20     \mbox{\hyperlink{ars_8h_a5ece5635db977edd094b1c365c0357a3}{\_\_u16}}  \mbox{\hyperlink{structmii__data_a56da2c8057f2b99b8d88f902096bffb1}{val\_in}};}
\DoxyCodeLine{21     \mbox{\hyperlink{ars_8h_a5ece5635db977edd094b1c365c0357a3}{\_\_u16}}  \mbox{\hyperlink{structmii__data_a902cab76c38cbec41a6a86bdbe4f6a2a}{val\_out}};}
\DoxyCodeLine{22 \};}
\DoxyCodeLine{23 }
...
\DoxyCodeLine{87     \textcolor{keywordtype}{char} \mbox{\hyperlink{structhpingif_aa21d6f1971a1dbdb9ed6b020765711c2}{hif\_name}}[\mbox{\hyperlink{interface_8h_abb3aac2fe74ddcfb8978bc1921ac2b75}{HPING\_IFNAME\_LEN}}];}
\DoxyCodeLine{88     in\_addr\_t \mbox{\hyperlink{structhpingif_a6d0d54dff5ef0c4a5dbbefeffe796b9c}{hif\_addr}}[\mbox{\hyperlink{interface_8h_aef958a99d9671105fcb27b51890fde9d}{HPING\_IFADDR\_MAX}}];   \textcolor{comment}{/* ipv4 addresses */}}
\DoxyCodeLine{89     in\_addr\_t \mbox{\hyperlink{structhpingif_a018173bbbc16d83cffa6d7d71d18e51d}{hif\_baddr}}[\mbox{\hyperlink{interface_8h_aef958a99d9671105fcb27b51890fde9d}{HPING\_IFADDR\_MAX}}]; \textcolor{comment}{/* ipv4 broadcast addresses */}}
\DoxyCodeLine{90     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a8ec3b6564a1c840994ee9df12a0d6089}{hif\_naddr}};}
\DoxyCodeLine{91     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a9cfb301071374d26e6469f65a4cee4c3}{hif\_loopback}};}
\DoxyCodeLine{92     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a28ca080e0b21a6a6e07406800375d4bf}{hif\_ptp}};}
\DoxyCodeLine{93     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a53966c3e5e46399ac66472fd275bde21}{hif\_promisc}};}
\DoxyCodeLine{94     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_aa4abf91e01fcb9a909047bcd06bbd507}{hif\_broadcast}};}
\DoxyCodeLine{95     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_afd510bf5382d1a1b35aa13e953e261e2}{hif\_nolink}}; \textcolor{comment}{/* only set with MII-\/capable devices */}}
\DoxyCodeLine{96     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a3ba27b8917e0127ef612f547f8b941c7}{hif\_mtu}};}
\DoxyCodeLine{97     \textcolor{keywordtype}{int} \mbox{\hyperlink{structhpingif_a5e20a5cff58e199a3992ae474caed59d}{hif\_index}}; \textcolor{comment}{/* only useful for linux sockpacket version */}}
\DoxyCodeLine{98 \};}
\DoxyCodeLine{99 }
\DoxyCodeLine{100 \textcolor{keywordtype}{int} \mbox{\hyperlink{interface_8h_a180366790b127c9f6d1f65245f275268}{hping\_get\_interfaces}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structhpingif}{hpingif}} *hif, \textcolor{keywordtype}{int} ilen);}
\DoxyCodeLine{101 }
