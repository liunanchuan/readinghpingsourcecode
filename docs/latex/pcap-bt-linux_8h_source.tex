\hypertarget{pcap-bt-linux_8h_source}{}\doxysection{pcap-\/bt-\/linux.h}
\label{pcap-bt-linux_8h_source}\index{libpcap-\/1.1.1/pcap-\/bt-\/linux.h@{libpcap-\/1.1.1/pcap-\/bt-\/linux.h}}
\mbox{\hyperlink{pcap-bt-linux_8h}{浏览该文件的文档.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{30 \textcolor{comment}{ * Bluetooth sniffing API implementation for Linux platform}}
\DoxyCodeLine{31 \textcolor{comment}{ * By Paolo Abeni <paolo.abeni@email.it>}}
\DoxyCodeLine{32 \textcolor{comment}{ *}}
\DoxyCodeLine{33 \textcolor{comment}{ * @(\#) \$Header: /tcpdump/master/libpcap/pcap-\/bt-\/linux.h,v 1.5 2008-\/04-\/04 19:37:45 guy Exp \$ (LBL)}}
\DoxyCodeLine{34 \textcolor{comment}{ */}}
\DoxyCodeLine{35 }
\DoxyCodeLine{36 \textcolor{comment}{/*}}
\DoxyCodeLine{37 \textcolor{comment}{ * Prototypes for Bluetooth-\/related functions}}
\DoxyCodeLine{38 \textcolor{comment}{ */}}
\DoxyCodeLine{39 \textcolor{keywordtype}{int} \mbox{\hyperlink{pcap-bt-linux_8h_af33c1907230627118031bd60e780ca7c}{bt\_platform\_finddevs}}(pcap\_if\_t **alldevsp, \textcolor{keywordtype}{char} *err\_str);}
\DoxyCodeLine{40 pcap\_t *\mbox{\hyperlink{pcap-bt-linux_8h_a3acfe105f35a3241698e5b3249204959}{bt\_create}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *\mbox{\hyperlink{structdevice}{device}}, \textcolor{keywordtype}{char} *ebuf);}
